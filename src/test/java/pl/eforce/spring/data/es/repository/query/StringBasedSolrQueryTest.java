...
import pl.eforce.spring.data.es.SolrServerFactory;
...
import pl.eforce.spring.data.es.repository.query.StringBasedSolrQuery;
...
public class StringBasedSolrQueryTest {
	...
	public void testQueryCreationSingleProperty() throws NoSuchMethodException, SecurityException {
		...
		pl.eforce.spring.data.es.core.query.Query query = solrQuery.createQuery(new SolrParametersParameterAccessor(
