...
import org.springframework.data.es.core.mapping.SimpleSolrPersistentEntity;
import org.springframework.data.es.core.mapping.ESDocument;
...
public class SimpleSolrPersistentEntityTest {
	...
	@ESDocument(solrCoreName = CORE_NAME)
