...
import org.springframework.data.es.core.ElasticSearchTemplate;
import org.springframework.data.es.repository.support.ElasticSearchRepositoryFactoryBean;
import org.springframework.data.repository.query.QueryLookupStrategy;
import org.springframework.data.repository.query.QueryLookupStrategy.Key;

/**
 * Annotation to enable ElasticSearch repositories. Will scan the package of the
...
public @interface EnableElasticSearchRepositories {
	...
	/**
	 * Configures the name of the {@link ElasticSearchTemplate} bean definition
	 * to be used to create repositories discovered through this annotation.
	 * Defaults to {@code elasticSearchTemplate}.
	 * 
	 * @return
	 */
	 ...
	 * instance. Defaults to {@link ElasticSearchRepositoryFactoryBean}.
	 * 
	 * @return
	 */
