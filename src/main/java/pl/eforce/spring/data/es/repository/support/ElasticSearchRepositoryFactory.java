...
import pl.eforce.spring.data.es.repository.query.ElasticSearchQueryMethod;
import pl.eforce.spring.data.es.repository.query.PartTreeElasticSearchQuery;
import pl.eforce.spring.data.es.repository.query.StringBasedElasticSearchQuery;
