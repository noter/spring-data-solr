...
public class SimpleElasticSearchMappingContext extends
	...
	public SimpleElasticSearchMappingContext(ElasticSearchClientFactory elasticSearchClientFactory) {
		super();

		Assert.notNull(elasticSearchClientFactory);
	...
	protected <T> SimpleElasticSearchPersistentEntity<?> createPersistentEntity(TypeInformation<T> typeInformation) {
		return new SimpleElasticSearchPersistentEntity<T>(typeInformation, elasticSearchClientFactory);
	}
